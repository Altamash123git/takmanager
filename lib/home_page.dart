        ...
        children: [
          Container(
            ...
            GridView.builder(
                ...
                itemBuilder: (ctx,i){
                  return
                    StreamBuilder<int>(stream: getCompletedTaskCount(), builder: (c,snapshot){
                      if(snapshot.hasData){
                    ...
                    child: ListTile(
                      ...
                      Text(topview[i]["completed"].toString()) ,
          ...
          Expanded(
            child: Container(
              ...
              child: StreamBuilder<QuerySnapshot<Map<String,dynamic>>>(stream: firestore.collection("tasks").snapshots(), builder: (c,snapshots){
                ...
                if(snapshots.hasData && snapshots.data!=null) {
                  return snapshots.data!.docs.isNotEmpty? ListView.builder(
                    ...
                    return ListTile(
                      onTap: (){
                        id=docs.id;
                        Navigator.push(context, MaterialPageRoute(builder: (_)=>detail_page(id:id , title: (data["title"]), desc: data["desc"])));
            
                      },
                      title: Text(data["title"]),
                      subtitle: Text(data["desc"]),
                      trailing: Text("${data["assignee"]} \n ${data["date"]}")
